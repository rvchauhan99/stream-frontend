    ...
    <div className="min-h-screen bg-dark-8 flex items-center justify-center p-4">
      <div className="bg-dark-10 rounded-xl p-8 w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          {!isLogin && (
            <div>
              <div className="relative">
                <PersonIcon className="absolute left-3 top-2.5 text-grey-70" />
                <input
                  type="text"
                  name="name"
                  value={formData.name}
          ...
          <div>
            <div className="relative">
              <EmailIcon className="absolute left-3 top-2.5 text-grey-70" />
              <input
                type="email"
                name="email"
          ...
          <div>
            <div className="relative">
              <LockIcon className="absolute left-3 top-2.5 text-grey-70" />
              <input
